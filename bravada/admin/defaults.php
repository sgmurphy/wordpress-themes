...
function bravada_get_option_defaults() {
	...
	"theme_lpslidercta1text"	=> _x('Read more','Slider CTA Text 1 default value','bravada'),
	"theme_lpslidercta1link"	=> '#lp-blocks',
	"theme_lpslidercta2text"	=> _x('See more','Slider CTA Text 2 default value','bravada'),
	"theme_lpslidercta2link"	=> '#lp-boxes-1',
	"theme_lpposts"				=> 1, // 2=static page, 1=posts, 0=disabled
	"theme_lpposts_more"		=> _x('More Posts','Landing page load more posts default label','bravada'),
	...
	"theme_lpboxreadmore1"		=> _x('Read More','Landing page text boxes 1 default read more label','bravada'),
	...
	"theme_lpboxreadmore2"		=> _x('Read More','Landing page text boxes 2 default read more label','bravada'),
	...
	"theme_excerptcont"		=> _x("Read more","Blog post excerpts default read more label","bravada"),
