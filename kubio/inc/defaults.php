...
$kubio_theme_svg_icons = array(
    ...
    'facebook-square'      => array (
        ...
        'content' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1536 1896.0833"><path d="M1248 128q119 0 203.5 84.5T1536 416v960q0 119-84.5 203.5T1248 1664h-188v-595h199l30-232h-229V689q0-56 23.5-84t91.5-28l122-1V369q-63-9-178-9-136 0-217.5 80T820 666v171H620v232h200v595H288q-119 0-203.5-84.5T0 1376V416q0-119 84.5-203.5T288 128h960z"/></svg>',
    ),
	'twitter'              => array(
...
$kubio_theme_divider_style = array(
...
return array(
	'default_icon'                      => $kubio_theme_svg_icons['fort-awesome'],
	'icons'                             => $kubio_theme_svg_icons,
	'divider_style'                     => $kubio_theme_divider_style,
	'lorem_ipsum'                       => $kubio_lorem_ipsum,
	'edit_this_text_in_customizer'      => $kubio_theme_click_pen_to_edit_title,
	'gradients'                         => $kubio_gradients,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $kubio_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $kubio_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $kubio_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'center',
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $kubio_gradients['night_fade'],
									'gradient_opacity' => 50,
									'shape'            =>
										array(
											'value'  => 'none',
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $kubio_theme_svg_icons['facebook-square'],
						'link_value' => 'https://www.facebook.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $kubio_theme_svg_icons['twitter-square'],
						'link_value' => 'https://www.twitter.com/',
						'index'      => 1,
					),
					array(
						'icon'       => $kubio_theme_svg_icons['youtube-square'],
						'link_value' => 'https://www.youtube.com/',
						'index'      => 2,
					),
					array(
						'icon'       => $kubio_theme_svg_icons['vimeo'],
						'link_value' => 'https://www.vimeo.com/',
						'index'      => 3,
					),
				),
			),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $kubio_theme_svg_icons['map-marker'],
						'text'       => 'Location, State, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $kubio_theme_svg_icons['phone'],
						'text'       => '(000) 123 12345',
						'link_value' => 'tel:(000) 123 12345',
						'index'      => 1,
					),
					array(
						'icon'       => $kubio_theme_svg_icons['envelope'],
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					...
					array(
						'icon'       => $kubio_theme_svg_icons['phone-square'],
						'text'       => '(000) 123 12345',
						'link_value' => '#',
						'index'      => 1,
					),
	...
	'blog_post_thumb_placeholder_color' => 'rgba(105,118,139, 1)',
