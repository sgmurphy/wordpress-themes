...
<div class="wp-block wp-block-kubio-dropdown-menu  position-relative wp-block-kubio-dropdown-menu__outer kubio-front-header__k__c6BbujDIAOY-outer kubio-local-663-outer kubio-dropdown-menu h-ignore-global-body-typography <?php echo $component->printHeaderMenuClasses(); ?>" data-kubio="kubio/dropdown-menu" data-kubio-component="dropdown-menu" data-kubio-settings="[]">
	...
	<div class="wp-block wp-block-kubio-menu-offscreen  position-relative wp-block-kubio-menu-offscreen__container kubio-front-header__k__r1Ph182_RWJ-container kubio-local-665-container" data-kubio="kubio/menu-offscreen">
		<div class="position-relative wp-block-kubio-menu-offscreen__align kubio-front-header__k__r1Ph182_RWJ-align kubio-local-665-align">
			<button class="position-relative wp-block-kubio-menu-offscreen__iconWrapper kubio-front-header__k__r1Ph182_RWJ-iconWrapper kubio-local-665-iconWrapper kubio-offscreen-icon-wrapper" data-target="#kubio-offscreen-65bb4b71eab7f" data-target-id="kubio-offscreen-65bb4b71eab7f" data-direction="right" data-width="300px" data-offcanvas-overlay-id="kubio-offscreen-65bb4b71eab7f-overlay" aria-label="<?php esc_attr_e( 'Mobile Menu', 'kubio' );?>" data-kubio-component="offcanvas" data-kubio-settings="[]">
  ...
  'wrapper_class' => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row kubio-front-header__k__nVjkPY2tu-container kubio-local--container',
  'logo_image_class' => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  kubio-front-header__k__nVjkPY2tu-image kubio-local--image',
  'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   kubio-front-header__k__nVjkPY2tu-alternateImage kubio-local--alternateImage',
  'logo_text_class' => 'position-relative wp-block-kubio-logo__text  kubio-front-header__k__nVjkPY2tu-text kubio-local--text',
)); ?>
										</div>
									</div>
								</div>
