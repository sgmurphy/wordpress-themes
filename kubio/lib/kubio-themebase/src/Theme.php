        ...
        <div class="kubio-onboarding kubio-step-1--active">
            <div>
                    ...
                    <div class="kubio-onboarding__wrapper__content">
                        <label>
                            ...
                            <div class="radio-card">
                                <div class="radio-card__radio-checked">
                                    <?php echo file_get_contents(kubio_theme()->getThemeResource('images/theme-base/check.svg')) ?>
                                    <div class="radio-card__radio-checked__background"></div>
                                </div>
                                <div class="radio-card__image-container">
                                    <img src="<?php echo kubio_theme()->getThemeResource('images/theme-base/web-layout.png')?>" alt="web-layout" draggable="false">
                                </div>
                                <span>
                        ...
                        <label>
                            ...
                            <div class="radio-card">
                                ...
                                <div class="radio-card__image-container">
                                    <img src="<?php echo kubio_theme()->getThemeResource('images/theme-base/blog-layout.png')?>" alt="blog-layout" draggable="false" >
                                </div>
                                <span>
                ...
                <div class="kubio-onboarding__wrapper kubio-step-2">
                    ...
                    <div class="kubio-onboarding__wrapper__content">
                        <p><?php Translations::escHtmlE( 'theme_description', kubio_theme()->getName() ); ?></p>

                        <ul>
                            <li>
                                <?php echo file_get_contents(kubio_theme()->getThemeResource('images/theme-base/round-check.svg')) ?>
