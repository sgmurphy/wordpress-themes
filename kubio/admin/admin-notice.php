        ...
        <div class="content-holder">
            <div class="messages-area">
                <div class="title-holder">
                    <h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', kubio_theme()->getName() ); ?></h1>
                    <p><?php Translations::escHtmlE( 'theme_description', kubio_theme()->getName() ); ?></p>
                </div>

                <ul>
                    <li>
                        <img src="<?php echo kubio_theme()->getListMarkerUrl()?>" alt="">
            ...
            <div class="front-page-preview">
                <img src="<?php echo esc_url( kubio_theme()->getFrontPagePreview() ); ?>"/>
            </div>
        </div>
    </div>
</div>
