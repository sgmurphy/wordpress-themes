        ...
        return
			...
			sprintf(  esc_html__( 'by %s ', 'rife-free' ),
                sprintf('<a class="vcard author" href="%1$s" title="%2$s" %4$s><span class="fn" %5$s>%3$s</span></a>',
                    ...
                    /* translators: %s - author name */
				    sprintf( esc_attr__( 'View all posts by %s', 'rife-free' ), esc_html(get_the_author() )),
            ...
            <div class="about-author comment"<?php apollo13framework_schema_args('author_box'); ?>>
                <div class="comment-body">
                    <?php $author_ID = get_the_author_meta( 'ID' );
                        ...
                        echo '<strong class="comment-author"><span class="author-name" '.apollo13framework_get_schema_args('name').'>'.esc_html(get_the_author()).'</span>';
