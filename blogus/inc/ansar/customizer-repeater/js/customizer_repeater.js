...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if(jQuery("#blogus_social_limit").val()==5)
        {
           jQuery(".customizer_blogus_social_upgrade_to_pro").show();
            return false;
        }
        else
        {
           var total_social_sections=parseInt(jQuery("#blogus_social_limit").val())+1;
           jQuery("#blogus_social_limit").val(total_social_sections)
           if(jQuery("#blogus_social_limit").val()>5)
        {
           jQuery(".customizer_blogus_social_upgrade_to_pro").hide();
        }
        }
     ...
     theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        var total_icon= parseInt(jQuery("#blogus_social_limit").val())-1;
       jQuery("#blogus_social_limit").val(total_icon);
