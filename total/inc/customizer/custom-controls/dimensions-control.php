...
/** Dimensions Control */
class Total_Dimensions_Control extends WP_Customize_Control {
    ...
    public function to_json() {
        ...
        $this->json['title'] = esc_html__('Link values together', 'total');
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'desktop_top' => esc_attr__('Top', 'total'),
            'desktop_right' => esc_attr__('Right', 'total'),
            'desktop_bottom' => esc_attr__('Bottom', 'total'),
            'desktop_left' => esc_attr__('Left', 'total'),
            'tablet_top' => esc_attr__('Top', 'total'),
            'tablet_right' => esc_attr__('Right', 'total'),
            'tablet_bottom' => esc_attr__('Bottom', 'total'),
            'tablet_left' => esc_attr__('Left', 'total'),
            'mobile_top' => esc_attr__('Top', 'total'),
            'mobile_right' => esc_attr__('Right', 'total'),
            'mobile_bottom' => esc_attr__('Bottom', 'total'),
            'mobile_left' => esc_attr__('Left', 'total'),
        );
        if (false === $id) {
