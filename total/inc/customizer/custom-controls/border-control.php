...
/** Border Control */
class Total_Border_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'border_width' => esc_attr__('Width', 'total'),
            'border_type' => esc_attr__('Border Type', 'total'),
            'color' => esc_attr__('Border Color', 'total'),
            'top' => esc_attr__('Top', 'total'),
            'right' => esc_attr__('Right', 'total'),
            'bottom' => esc_attr__('Bottom', 'total'),
            'left' => esc_attr__('Left', 'total')
        );
        if (false === $id) {
        ...
        <ul>
            ...
            <li class="ht--border-color">
                ...
                <div class="customize-control-content">
                    <input class="ht--color-picker-hex" type="text" maxlength="7" placeholder="<?php esc_attr_e('Hex Value', 'total'); ?>" {{{ data.color.link }}} value="{{ data.color.value }}"  />
                </div>
            </li>
            <# } #>
    ...
    function get_all_border_types() {
        return array(
            ...
            'solid' => esc_attr__('Solid', 'total'),
            'double' => esc_attr__('Double', 'total'),
            'dotted' => esc_attr__('Dotted', 'total'),
            'dashed' => esc_attr__('Dashed', 'total'),
            'groove' => esc_attr__('Groove', 'total')
        );
    }
