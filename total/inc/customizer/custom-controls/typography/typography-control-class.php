...
class Total_Typography_Control extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_script('ht--customize-typograhpy-controls', TOTAL_CUSTOMIZER_URL . 'custom-controls/typography/js/customize-controls.js', array('jquery'), TOTAL_VERSION, true);
        wp_enqueue_style('ht--customize-typograhpy-controls', TOTAL_CUSTOMIZER_URL . 'custom-controls/typography/css/customize-controls.css', array(), TOTAL_VERSION);
    }
