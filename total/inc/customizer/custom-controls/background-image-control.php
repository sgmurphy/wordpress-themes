...
/** Background Control */
class Total_Background_Image_Control extends WP_Customize_Control {
    ...
    public function __construct($manager, $id, $args = array()) {
        ...
        $this->button_labels = apply_filters('total_customizer_background_button_labels', $button_labels, $id);

        // Set field labels
        $field_labels = $this->get_field_labels();
        $this->field_labels = apply_filters('total_customizer_background_field_labels', $field_labels, $id);

        // Set background choices
        $background_choices = $this->get_background_choices();
        $this->background_choices = apply_filters('total_customizer_background_choices', $background_choices, $id);
    }
    ...
    public static function get_button_labels() {
        ...
        $button_labels = array(
            'select' => esc_html__('Select Image', 'total'),
            'remove' => esc_html__('Remove', 'total'),
        );
    ...
    public static function get_background_choices() {
        ...
        $choices = array(
            'repeat' => array(
                ...
                'repeat' => esc_html__('Tile', 'total'),
                'repeat-x' => esc_html__('Tile Horizontally', 'total'),
                'repeat-y' => esc_html__('Tile Vertically', 'total')
            ),
            'size' => array(
                'auto' => esc_html__('Default', 'total'),
                'cover' => esc_html__('Cover', 'total'),
                'contain' => esc_html__('Contain', 'total')
            ),
            'position' => array(
                'left-top' => esc_html__('Left Top', 'total'),
                'left-center' => esc_html__('Left Center', 'total'),
                'left-bottom' => esc_html__('Left Bottom', 'total'),
                'right-top' => esc_html__('Right Top', 'total'),
                'right-center' => esc_html__('Right Center', 'total'),
                'right-bottom' => esc_html__('Right Bottom', 'total'),
                'center-top' => esc_html__('Center Top', 'total'),
