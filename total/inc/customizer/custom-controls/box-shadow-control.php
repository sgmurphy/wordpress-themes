...
/** Color Tab Control */
class Total_Box_Shadow_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'box_shadow' => esc_attr__('Box Shadow', 'total'),
            'x' => esc_attr__('X', 'total'),
            'y' => esc_attr__('Y', 'total'),
            'blur' => esc_attr__('Blur', 'total'),
            'spread' => esc_attr__('Spread', 'total'),
            'inset' => esc_attr__('Inset', 'total'),
            'color' => esc_attr__('Color', 'total'),
        );
        if (false === $id) {
