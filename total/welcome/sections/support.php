<div class="support-wrap">
    <div class="support-col">
        ...
        printf(
            ...
            esc_html__('Read the detailed documentation of the theme. The documentation contains all the necessary information required to set up the %s theme.', 'total'), esc_html($this->theme_name));
        ?></p>
    ...
    <div class="support-col">
        ...
        <p><?php echo esc_html__('Still, having problems after reading all the documentation? No Problem!! Please create a support ticket. Our dedicated support team will help you to solve your problem.', 'total'); ?></p>
