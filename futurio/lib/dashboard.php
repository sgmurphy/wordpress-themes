		...
		public function admin_notices() {
			...
			<div class="notice notice-info futurio-notice-nux is-dismissible">
				<div class="futurio-row">
					<div class="futurio-col">
						<div class="notice-content">
							<?php if ( !futurio_is_extra_activated() && current_user_can( 'install_plugins' ) && current_user_can( 'activate_plugins' ) ) : ?>
								...
								<p>
									<?php Futurio_Plugin_Install::install_plugin_button( 'futurio-extra', 'futurio-extra.php', 'Futurio Extra', array( 'sf-nux-button' ), __( 'Activated', 'futurio' ), __( 'Activate', 'futurio' ), __( 'Install', 'futurio' ) ); ?>
									<a href="<?php echo esc_url( admin_url( 'themes.php?page=futurio' ) ); ?>" class="button button-primary futurio-get-started" style="text-decoration: none;">
										<?php
										/* translators: %s: Theme name */
					...
					<div class="futurio-col futurio-col-right">
						<div class="image-container">
							<?php echo '<img src="' . esc_url( get_template_directory_uri() ) . '/img/futurio-banner.png"/>'; ?>
						</div>
					</div>
				</div>
			</div>
