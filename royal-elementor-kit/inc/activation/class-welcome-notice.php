	...
	*/
	public function render_notice_content() {
		...
		<div class="welcome-message" style="<?php echo esc_attr($flex_attr); ?>">
			...
			<p>
				<?php echo sprintf( esc_html__( 'Royal Elementor Kit comes with %s with various designs to pick from.', 'royal-elementor-kit' ), '<strong><a href="https://demosites.royal-elementor-addons.com/elementor-templates/?ref=royal-elementor-theme-wellcome-banner" target="_blank">Elementor based 80+ sites library </a></strong>' ); ?>
				<?php echo sprintf( esc_html__('%s  and many other Elementor Extensions & Effects.', 'royal-elementor-kit'), '<strong><a href="https://royal-elementor-addons.com/royal-elementor-kit/?ref=royal-elementor-theme-wellcome-banner#widgets" target="_blank">90+ Premium Elementor Widgets like Post and Product Grid, Slider, Menu,</a><a href="https://royal-elementor-addons.com/royal-elementor-kit/?ref=royal-elementor-theme-wellcome-banner#headerfooterbuilder"  target="_blank"> Theme & Woocommerce Shop Builder</a><a href="https://royal-elementor-addons.com/royal-elementor-kit/?ref=royal-elementor-theme-wellcome-banner#popupbuilder" target="_blank">, Popup Builder </a></strong>') ?>
