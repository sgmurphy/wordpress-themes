    ...
    class Kirki_Field
    {
        ...
        public function __construct($config_id = 'global', $args = array())
        {
            ...
            $whitelisted = apply_filters('kirki/' . $this->kirki_config . '/fields/properties_whitelist', array(
                'group'       => '', // This is sanitized later in the controls themselves.
                'in_row_with' => array(), // This is sanitized later in the controls themselves.
            ...
            if (isset($args['active_callback'])) {
                $whitelisted["active_callback_vars"] = $args['active_callback'];

            }

            if (isset($args['update'])) {
                $whitelisted["update"] = $args['update'];
            }
        ...
        protected function set_partial_refresh()
        {
            ...
            if ( ! apply_filters('mesmerize_enable_kirki_selective_refresh', true)) {
                return;
            }
