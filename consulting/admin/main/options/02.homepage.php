...
$slider_default          = NULL;
	...
	if ( is_front_page() ) {
		...
		if ( ( consulting_thinkup_check_permission() and empty( $thinkup_homepage_sliderswitch ) ) or $thinkup_homepage_sliderswitch == 'option1' ) {
...
$thinkup_homepage_section3_link  = consulting_thinkup_var ( 'thinkup_homepage_section3_link' );
	...
	if ( is_front_page() ) {
		if ( ( consulting_thinkup_check_permission() and empty( $thinkup_homepage_sectionswitch ) ) or $thinkup_homepage_sectionswitch == '1' ) {
