...
//			array(
//				'title'        => __( 'Need help?', 'consulting' ),
//				'priority'     => 1,
//				'button_text'  => __( 'Hire a Developer', 'consulting' ),
	...
	$wp_customize->add_control(
		new consulting_thinkup_customizer_customcontrol_upgrade_inner(
			...
			array(
				...
				'price_discount'  => __( 'Upgrade Now (10% off)', 'consulting' ),
				'price_normal'	  => __( 'Use coupon at checkout for 10% off.', 'consulting' ),
				'coupon'	      => __( 'thinkup10', 'consulting' ),
